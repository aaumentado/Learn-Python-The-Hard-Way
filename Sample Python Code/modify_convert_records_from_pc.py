...
RECORDS_DIR = 'Z:/convert_records.txt'

CONVERT_RECORDS_HEADS = ['resfile', 'date_converted', 'res_filesize', 'csv_filesize']

RECORDS_TO_DELETE = ['X-LW2-9-1_FSOC1-1.res','X-LW2-9-2_FSOC1-1.res','X-LW2-9-3_FSOC1-1.res','X-LW2-9-4_FSOC1-1.res','X-LW2-9-5_FSOC1-1.res','X-LW2-9-6_FSOC1-1.res']
